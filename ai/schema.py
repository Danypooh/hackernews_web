...
LINEAR_SERVER_URL = 'https://linear-model-service-danypooh.cloud.okteto.net/v1/models/linear-model:predict'

RESNET_SERVER_URL = 'https://resnet-service-danypooh.cloud.okteto.net/v1/models/resnet:predict'
