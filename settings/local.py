...
SECRET_KEY = 'k@*-qm80&!9$s9f*n4-)ug^3i)g@o_fhd(5tzuby%k3$o^5pm8'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hackernews', #'bhkvrhxz'
        'USER': 'postgres', #'bhkvrhxz',
        'PASSWORD': 'AIfat', #'jZLX4MXoWAkyiCYLKr6CxfHMhwafU4Nb',
